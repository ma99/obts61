    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-header bg-info text-white">Phone Verification</div>
                    ...
                    <div class="d-flex">
                        <div class="col-6 offset-3">
                            <form method="POST" action="{{ route('password.verify.phone') }}">
                                ...
                                <span>A <strong class="text-secondary">verification code</strong> has been sent to your phone. Please enter the code below. </span>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-warning btn-block">Verify Phone</button>
                                </div>
                            </form>                            
                        </div>
